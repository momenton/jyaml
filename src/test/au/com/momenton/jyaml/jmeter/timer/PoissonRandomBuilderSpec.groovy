...
class PoissonRandomTimerBuilderSpec extends Specification {
    ...
    def "non-mandatory fields set correctly"() {
        ...
        testPlan.contains(JMeterTestUtils.getStringPropertyElement(PoissonRandomTimer.COMMENTS, comment))
        testPlan.contains(JMeterTestUtils.getStringPropertyElement(PoissonRandomTimerBuilder.DELAY, "123"))
        testPlan.contains(JMeterTestUtils.getStringPropertyElement(PoissonRandomTimerBuilder.RANGE, "1000"))
